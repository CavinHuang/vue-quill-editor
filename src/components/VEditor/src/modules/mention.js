...
import Keys from '../keyboard/mention'
import {
  attachDataValues,
  getMentionCharIndex,
  hasValidChars,
...
import '../../style/quill.mention.css'
...
class Mention {
  constructor (quill, options) {
    ...
    quill.keyboard.addBinding({ key: Keys.TAB }, this.selectHandler.bind(this))
  ...
  setMentionContainerPosition () {
    if (this.options.positioningStrategy === 'fixed') {
      ...
      this.setMentionContainerPositionNormal()
    }
  }

  setMentionContainerPositionNormal () {
